...
export function AppShell({ brand, identity, groupInitials, navItems, navFooterItems, navAriaLabel, activeId, onNavigate, crumbs, onCmdK, onIdentityClick, topBarExtras, activity, groupSwitcher, fmtSettings, children, className, }) {
    ...
    return (_jsx(FmtProvider, { ...(fmtSettings ?? {}), children: _jsxs("div", { className: ["cc-shell", className].filter(Boolean).join(" "), children: [_jsx(OfflineBanner, {}), _jsx(TopBar, { brand: brand, identity: identity, onCmdK: onCmdK, onIdentityClick: onIdentityClick, extras: extras }), _jsxs("div", { className: "cc-shell__body", children: [items.length > 0 ? (_jsx(NavRail, { items: items, footerItems: navFooterItems, ariaLabel: navAriaLabel, renderItem: onNavigate
