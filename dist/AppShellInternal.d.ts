...
export declare function AppShellInternal({ brand, identity, groupInitials, navItems, navFooterItems, navAriaLabel, activeId, onNavigate, crumbs, onCmdK, onIdentityClick, topBarExtras, activity, groupSwitcher, fmtSettings, children, className, }: AppShellInternalProps): React.ReactElement;
//# sourceMappingURL=AppShellInternal.d.ts.map