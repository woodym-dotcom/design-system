...
export declare function CompactListRow({ title, subtitle, trailing, href, onClick, isSelected, className, }: CompactListRowProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=CompactListRow.d.ts.map