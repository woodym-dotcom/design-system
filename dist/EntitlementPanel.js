...
export function EntitlementPanel({ recipient, entitlements, title, groupBy = "type", onEntitlementClick, className, }) {
    ...
    const countLabel = (_jsxs("span", { className: "cc-entitlement-panel__count", style: {
            fontSize: "var(--text-xs, 0.75rem)",
            color: "var(--text-3)",
        }, children: [entitlements.length, " entitlement", entitlements.length !== 1 ? "s" : ""] }));
    return (_jsx(Card, { title: heading, actions: countLabel, padded: true, className: classes, role: "region", "aria-label": heading, children: Array.from(groups.entries()).map(([key, items]) => (_jsxs("section", { className: "cc-entitlement-panel__group", style: { marginBottom: "var(--space-4, 0.75rem)" }, children: [_jsx("h4", { className: "cc-entitlement-panel__group-label", style: {
