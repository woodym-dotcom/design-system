...
export function PlatformAppShell({ brand, modules, appKey, user, companyGroups, apps, onSignOut, onSwitchApp, onSwitchCompanyGroup, onNavigate, children, topBarSlot, navFooterSlot, commandPalette, activeModuleId, className, }) {
    ...
    const brandNode = (_jsx("span", { className: `cc-platform-shell__brand cc-platform-shell__brand--${brand}`, children: brandLabel }));
    const rootClass = [
        'cc-platform-shell',
        'cc-shell',
        ...
        .filter(Boolean)
        .join(' ');
    return (_jsx(FmtProvider, { children: _jsxs("div", { className: rootClass, "data-brand": brand, children: [_jsx(OfflineBanner, {}), _jsx(TopBar, { brand: brandNode, showCmdK: Boolean(commandPalette), onCmdK: commandPalette ? () => setPaletteOpen(true) : undefined, extras: topBarExtras }), _jsxs("div", { className: "cc-shell__body", children: [modules.length > 0 ? (_jsx(NavRail, { items: navItems, footerItems: navFooterSlot
                                ...
                                if (item.id === '__platform_shell_footer__') {
                                    return (_jsx("div", { className: "cc-platform-shell__nav-footer", "data-testid": "platform-shell-nav-footer", children: navFooterSlot }));
                                }
...
//# sourceMappingURL=PlatformAppShell.js.map