...
export type GraphLayout =
  ...
  | "tile"           // KPI tile: big value + delta + mini sparkline
  | "card"           // metric card: chart + title + series toggles
  | "dashboard"      // larger dashboard chart card (DashboardChartCard lineage)
  | "heatmap"        // categorical matrix (row × col cells)
  | "force"          // network/relationship graph (stub — coming v1.1)
  | "hierarchical"   // tree graph (stub — coming v1.1)
