...
function renderShell(overrides: Partial<React.ComponentProps<typeof AppShell>> = {}) {
  ...
  const utils = render(<AppShell {...props} />);
  return { ...utils, props };
}

describe('AppShell — landmarks + slots', () => {
...
describe('AppShell — app switcher', () => {
...
describe('AppShell — company-group switcher', () => {
